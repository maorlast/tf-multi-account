...
resource "aws_eks_node_group" "this" {
  ...
  scaling_config {
    desired_size = var.nodes_per_az * length(var.private_subnet_ids)
    min_size     = var.nodes_per_az * length(var.private_subnet_ids)
    max_size     = var.nodes_per_az * length(var.private_subnet_ids) * 2
  }
